CREATE USER IF NOT EXISTS 'servatrice' IDENTIFIED BY 'password';
CREATE DATABASE IF NOT EXISTS `servatrice` CHARACTER SET `utf8`;
GRANT ALL PRIVILEGES ON servatrice.* TO 'servatrice';
FLUSH PRIVILEGES;
